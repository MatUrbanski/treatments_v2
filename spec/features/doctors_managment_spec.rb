...
feature 'Doctors' do
  ...
  feature 'Create' do
    ...
    scenario 'should create new doctor' do
      ...
      expect(page).to have_text(t('doctors.create.created'))
    ...
    scenario 'should not create new doctor' do
      ...
      expect(page).to_not have_text(t('doctors.create.created'))
  ...
  feature 'Update' do
    ...
    scenario 'should update doctor' do
      ...
      expect(page).to have_text(t('doctors.update.updated'))
    ...
    scenario 'should not update doctor' do
      ...
      expect(page).to_not have_text(t('doctors.update.updated'))
  ...
  feature 'Deleting doctor that not have any associated records' do
    scenario 'should delete existing Doctor' do
      ...
      expect(page).to have_text(t('doctors.destroy.destroyed'))
      expect(current_path).to eq doctors_path
    end
  end
